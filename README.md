...
> That is why I recommend just placing it in the root of the <code>C:\</code> drive for easier access. Oh, and don't forget to include the actual .exe extension and not just <code>C:\MBRUnins</code>!
